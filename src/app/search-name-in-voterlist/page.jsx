...
const content = {
	en: {
		...
		note: "If your name is not found, you may need to apply for inclusion or correction through the Election Commission portal.",
	},
	...
	mr: {
		...
		note: "आपले नाव आढळले नाही, तर निवडणूक आयोगाच्या अधिकृत पोर्टलवरून नाव नोंदणी किंवा दुरुस्तीसाठी अर्ज करावा लागू शकतो.",
	},
};

export default function CheckVoterNamePage() {
